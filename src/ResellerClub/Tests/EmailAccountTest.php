...
class EmailAccountTest {
    ...
    public function addUser() {
        ...
        $ca = $this->apicaller->emailaccount()->addUser(array(
            'order-id' => '54792315',
            'email' => 'ajaykumar.gupta@netfunda.com',
            'passwd' => 'netfunda@123',
            'notification-email' => 'ajaykumar.gupta@netfunda.com',
            'first-name' => 'sgdfgdf',
            'last-name' => 'lastnadfgdfme',
            'country-code' => 'US',
            'language-code' => 'en'
        ));
    ...
    public function addForwardOnlyAccount() {
        ...
        $pd = $this->apicaller->emailaccount()->addForwardOnlyAccount(array(
            'order-id' => '54792315',
            'email' => 'ajaykumar.gupta@netfunda.com',
            'forwards' => 'srikanta.mondal@netfunda.com'
                )
        );
        echo "<pre>";
        print_r($pd);
