 ...
 */
class RHWindowsPlans extends APICallerAbstract {
    ...
    public function add(array $params,$slcode) {
        ...
        $endPoint = Http::prepare('resellerhosting/windows/'.$slcode.'/add.json');
    ...
    public function renew(array $params,$slcode) {
        ...
        $endPoint = Http::prepare('resellerhosting/windows/'.$slcode.'/renew.json');
        $response = Http::send($this->apicaller, $endPoint, $params, 'POST');
    ...
    public function modify(array $params,$slcode) {
        ...
        $endPoint = Http::prepare('resellerhosting/windows/'.$slcode.'/modify.json');
        $response = Http::send($this->apicaller, $endPoint, $params, 'POST');
    ...
    public function addDedicatedIP(array $params,$slcode) {
        $endPoint = Http::prepare('resellerhosting/windows/'.$slcode.'/add-dedicated-ip.json');
        $response = Http::send($this->apicaller, $endPoint, $params, 'POST');
    ...
    */
    public function deleteDedicatedIP(array $params,$slcode) {
        $endPoint = Http::prepare('resellerhosting/windows/'.$slcode.'/delete-dedicated-ip.json');
        $response = Http::send($this->apicaller, $endPoint, $params, 'POST');
    ...
    */
    public function delete(array $params,$slcode) {
        $endPoint = Http::prepare('resellerhosting/windows/'.$slcode.'/delete.json');
        $response = json_decode(Http::send($this->apicaller, $endPoint, $params, 'POST'));
    ...
    */
    public function getDetails(array $params,$slcode) {
        $endPoint = Http::prepare('resellerhosting/windows/'.$slcode.'/details.json');
    ...
    */
    public function generateLicenseKey(array $params,$slcode) {
        $endPoint = Http::prepare('resellerhosting/windows/'.$slcode.'/generate-license-key.json');
        $response = json_decode(Http::send($this->apicaller, $endPoint, $params, 'POST'));
        if (!is_object($response)) {
            throw new ResponseException(__METHOD__);
        }
    ...
    */
    public function getOrderId(array $params,$slcode) {
        $endPoint = Http::prepare('resellerhosting/windows/'.$slcode.'/orderid.json');
        $response = json_decode(Http::send($this->apicaller, $endPoint, $params, 'GET'));
        if (!is_object($response)) {
            throw new ResponseException(__METHOD__);
        }
    ...
    */
    public function searchOrders(array $params,$slcode) {
        $endPoint = Http::prepare('resellerhosting/windows/'.$slcode.'/search.json');
        $response = json_decode(Http::send($this->apicaller, $endPoint, $params, 'GET'));
        if (!is_object($response)) {
            throw new ResponseException(__METHOD__);
        }
    ...
    public function modifyPrice(array $params,$slcode) {
        ...
        $endPoint = Http::prepare('resellerhosting/windows/'.$slcode.'/modify-pricing.json');
    ...
    */
    public function changeHostingPanelPassword(array $params,$slcode) {
        $endPoint = Http::prepare('resellerhosting/windows/'.$slcode.'/change-password.json');
        $response = json_decode(Http::send($this->apicaller, $endPoint, $params, 'POST'));
    ...
    */
    public function getDNSRecords(array $params,$slcode) {
        $endPoint = Http::prepare('resellerhosting/windows/'.$slcode.'/dns-record.json');
        $response = json_decode(Http::send($this->apicaller, $endPoint, $params, 'GET'));
        if (!is_object($response)) {
            throw new ResponseException(__METHOD__);
        }
