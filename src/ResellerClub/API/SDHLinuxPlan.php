...
class SDHLinuxPlan extends APICallerAbstract {
...
public function ReNew(array $params,$country){
   ...
   $endPoint = Http::prepare("singledomainhosting/linux/".$country."/renew.json");
...
public function Modify(array $params,$country){
      ...
      $endPoint = Http::prepare('singledomainhosting/linux/'.$country.'/modify.json');
...
public function EnableSSL(array $params,$country){
      ...
      $endPoint = Http::prepare('singledomainhosting/linux/'.$country.'/enable-ssl.json');
      $response = json_decode(Http::send($this->apicaller, $endPoint, $params, 'GET'));
        if (!is_object($response)) {
            throw new ResponseException(__METHOD__);
        }
...
public function DisableSSL(array $params,$country){
      ...
      $endPoint = Http::prepare('singledomainhosting/linux/'.$country.'/disable-ssl.json');
      $response = json_decode(Http::send($this->apicaller, $endPoint, $params, 'GET'));
        if (!is_object($response)) {
            throw new ResponseException(__METHOD__);
        }
...
public function Delete(array $params,$country){
      ...
      $endPoint = Http::prepare('singledomainhosting/linux/'.$country.'/delete.json');
      $response = json_decode(Http::send($this->apicaller, $endPoint, $params, 'GET'));
        if (!is_object($response)) {
            throw new ResponseException(__METHOD__);
        }
...
public function Details(array $params,$country){
      ...
      $endPoint = Http::prepare('singledomainhosting/linux/'.$country.'/details.json');
      $response = json_decode(Http::send($this->apicaller, $endPoint, $params, 'POST'));
        if (!is_object($response)) {
            throw new ResponseException(__METHOD__);
        }
...
public function GetOrderId(array $params,$country){
      ...
      $endPoint = Http::prepare('singledomainhosting/linux/'.$country.'/orderid.json');
      $response = Http::send($this->apicaller, $endPoint, $params, 'GET');
...
public function SearchOrder(array $params,$country){
      ...
      $endPoint = Http::prepare('singledomainhosting/linux/'.$country.'/search.json');
      $response = Http::send($this->apicaller, $endPoint, $params, 'GET');
...
public function GetUpgradePrice(array $params,$country){
      ...
      $endPoint = Http::prepare('singledomainhosting/linux/'.$country.'/modify-pricing.json');
      $response = Http::send($this->apicaller, $endPoint, $params, 'GET');
...
public function ChangeHostingPanelPassword(array $params,$country){
      ...
      $endPoint = Http::prepare('singledomainhosting/linux/'.$country.'/change-password.json');
      $response = Http::send($this->apicaller, $endPoint, $params, 'GET');
